...
public class CalculatorTest5 {
	...
	void testMultiplyWithProperName(int number, int multiplier, CalcOutput expectedResult) {
		...
		assertAll(() -> assertEquals(expectedResult.getMultiplicationResult(), actualResult.getMultiplicationResult()),
	...
	static Stream<Arguments> testData() {
		...
		return Stream.of(Arguments.of(5, 3, new CalcOutput(15, 8)), Arguments.of(5, 1, new CalcOutput(5, 6)),
				Arguments.of(5, 0, new CalcOutput(0, 5)), Arguments.of(5, -5, new CalcOutput(-25, 0)));
